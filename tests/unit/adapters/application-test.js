...
test('Find Query with non-string where', function (assert) {
  ...
  }, 'where clause is passed as stringified data');
...
test('Find Query with where as string', function (assert) {
  ...
  assert.deepEqual(ajaxHash.data, {
    where: "{title: 'First Post'}"
  }, 'where clause is passed through as string');
